...
const videosPosts: Post[] = [
  ...
  },
  {
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'rodrigo_m', text: 'Isso aqui devia ser proibido 😵‍💫' },
      { user: 'lucas_s', text: 'Tô precisando de gelo pra sobreviver 🥶' },
      { user: 'felipe_p', text: 'Que vídeo é esse? Tô transtornado 😈' }
    ]
  },
  {
    id: 'video-3',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'joao_c', text: 'Tô hipnotizado, ajuda 😈' },
      { user: 'carlos_v', text: 'Alguém segura meu coração 💀' },
      { user: 'marcelo_f', text: 'Isso aqui é arma de destruição em massa 🥶' }
    ]
  },
  {
    id: 'video-4',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'bruno_a', text: 'Que maldade, cê tá brincando com a gente 😵‍💫' },
      { user: 'rafael_p', text: 'Não é justo ser tão provocante 💀' },
      { user: 'diogo_s', text: 'Preciso de resgate, tô queimando 🥵' }
    ]
  },
  {
    id: 'video-5',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'gustavo_l', text: 'Meu Deus, é quase um pecado assistir 😈' },
      { user: 'fernando_m', text: 'Tô tremendo aqui 🥶' },
      { user: 'daniel_a', text: 'Que vídeo! Vou precisar de reanimação 💀' }
    ]
  },
  {
    id: 'video-6',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'mateus_k', text: 'Essa é de parar o coração 😈' },
      { user: 'vinicius_t', text: 'Tô me sentindo fraco só de olhar 💀' },
      { user: 'gabriel_n', text: 'Preciso de proteção, tá pegando fogo 🥵' }
    ]
  },
  {
    id: 'video-7',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'henrique_w', text: 'Não aguento tanta ousadia 😵‍💫' },
      { user: 'leonardo_q', text: 'Que diabos de vídeo é esse? 🥶' },
      { user: 'arthur_z', text: 'Meu coração não sobrevive 💀' }
    ]
  },
  {
    id: 'video-8',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'eduardo_x', text: 'Tô sofrendo, socorro 🥵' },
      { user: 'ricardo_y', text: 'Isso deveria vir com aviso de risco 😈' },
      { user: 'fabio_u', text: 'Perigoso demais pra mim 💀' }
    ]
  },
  {
    id: 'video-9',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'otavio_i', text: 'Meu Deus, tô sem fôlego 😵‍💫' },
      { user: 'caio_o', text: 'Essa é de explodir a cabeça 🥶' },
      { user: 'renato_e', text: 'Tô queimando só de assistir 😈' }
    ]
  },
  {
    id: 'video-10',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'alessandro_r', text: 'Sério, que vídeo é esse? 🥶' },
      { user: 'mauricio_t', text: 'Tô perdido só de olhar 💀' },
      { user: 'jefferson_y', text: 'Isso aqui é perigoso demais 😈' }
    ]
  },
  {
    id: 'video-11',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'wellington_u', text: 'Que maldade, tá brincando com meu coração 😈' },
      { user: 'emerson_i', text: 'Não aguento tanta ousadia 💀' },
      { user: 'anderson_o', text: 'Tô tremendo todo aqui 🥶' }
    ]
  },
  {
    id: 'video-12',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'everton_a', text: 'Isso é arma de destruição de nervos 😵‍💫' },
      { user: 'robson_s', text: 'Cuidado, tá pegando fogo 🥵' },
      { user: 'wagner_d', text: 'Tô sem palavras 💀' }
    ]
  },
  {
    id: 'video-13',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'claudio_f', text: 'Que vídeo é esse, meu Deus 😈' },
      { user: 'sergio_g', text: 'Tô precisando de resgate 🥶' },
      { user: 'marcio_h', text: 'Alerta vermelho total 💀' }
    ]
  },
  {
    id: 'video-14',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'leandro_j', text: 'Tô sem ar só de olhar 🥵' },
      { user: 'adriano_k', text: 'Impossível resistir 💀' },
      { user: 'flavio_l', text: 'Perigo, perigo, perigo 😵‍💫' }
    ]
  },
  {
    id: 'video-15',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'cristiano_m', text: 'Isso aqui é criminoso 😈' },
      { user: 'juliano_n', text: 'Tô tremendo todo 🥵' },
      { user: 'valter_p', text: 'Meu coração não aguenta 💀' }
    ]
  },
  {
    id: 'video-16',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'nelson_q', text: 'Não aguento tanta ousadia 😵‍💫' },
      { user: 'gilberto_r', text: 'Socorro, tô derretendo 🥵' },
      { user: 'ronaldo_s', text: 'Que diabos de vídeo é esse 💀' }
    ]
  },
  {
    id: 'video-17',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'wilson_t', text: 'Tô hipnotizado 😈' },
      { user: 'edson_u', text: 'Perigo, muito perigo 🥶' },
      { user: 'silvio_v', text: 'Meu Deus, tá quente demais 💀' }
    ]
  },
  {
    id: 'video-18',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'cesar_w', text: 'Isso deveria ser proibido 😵‍💫' },
      { user: 'alex_x', text: 'Tô queimando aqui 🥵' },
      { user: 'junior_z', text: 'Meu coração quase explodiu 💀' }
    ]
  },
  {
    id: 'video-19',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'douglas_aa', text: 'Que diabos é isso? 😈' },
      { user: 'paulo_bb', text: 'Não sei se rio ou choro 🥵' },
      { user: 'marcos_cc', text: 'Tô tremendo todo 💀' }
    ]
  },
  {
    id: 'video-20',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'antonio_dd', text: 'Meu Deus, tá insano 😈' },
      { user: 'jose_ee', text: 'Tô hipnotizado 🥶' },
      { user: 'francisco_ff', text: 'Isso aqui é perigoso demais 💀' }
    ]
  },
  {
    id: 'video-21',
    ...
    likes: Math.floor(Math.random() * 5000) + 200,
    comments: [
      { user: 'manoel_gg', text: 'Sério, isso é real? 😈' },
      { user: 'raimundo_hh', text: 'Tô sem ar 🥵' },
      { user: 'sebastiao_ii', text: 'Meu coração tá em choque 💀' }
    ]
  }
];
